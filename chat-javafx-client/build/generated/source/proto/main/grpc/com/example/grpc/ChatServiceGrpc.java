...
public final class ChatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.grpc.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.Chat.ChatMessage,
      com.example.grpc.Chat.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = com.example.grpc.Chat.ChatMessage.class,
      responseType = com.example.grpc.Chat.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.grpc.Chat.ChatMessage,
      com.example.grpc.Chat.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.Chat.ChatMessage, com.example.grpc.Chat.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.Chat.ChatMessage, com.example.grpc.Chat.ChatMessageFromServer>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.Chat.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.grpc.Chat.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.example.grpc.Chat.ChatMessageFromServer> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                ...
                com.example.grpc.Chat.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.Chat.getDescriptor();
    }
